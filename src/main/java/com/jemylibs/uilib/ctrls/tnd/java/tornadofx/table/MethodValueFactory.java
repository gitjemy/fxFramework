...
public class MethodValueFactory<S, T> implements Callback<TableColumn.CellDataFeatures<S, T>, ObservableValue<T>> {
    private final String property;
    private Field field;

    public MethodValueFactory(@NamedArg("property") String property) {
