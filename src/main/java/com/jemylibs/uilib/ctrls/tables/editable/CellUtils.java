...
class CellUtils {
    ...
    static void updateItem(final Cell<LocalDate> cell,
                           final HBox hbox,
                           final Node graphic,
        ...
        if (cell.isEmpty()) {
            ...
            if (cell.isEditing()) {
                ...
                if (graphic != null) {
                    hbox.getChildren().setAll(graphic, datePicker);
                    cell.setGraphic(hbox);
                } else {
                    cell.setGraphic(datePicker);
                }
            } else {
                cell.setText(JDateTime.str_date(cell.getItem()));
                cell.setGraphic(graphic);
            }
        }
    }
    ...
    static DatePicker createDatePicker(final Cell<LocalDate> cell) {
